...
const DiscordSystemMessage = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: clsx('discord-system-message', `discord-${this.type}-system-message`, { 'discord-channel-name-change': this.channelName }) }, index.h("div", { class: "discord-message-icon" }, icon), index.h("div", { class: "discord-message-content" }, index.h("span", null, index.h("slot", null), index.h("span", { class: "discord-message-timestamp" }, this.timestamp)), index.h("slot", { name: "reactions" }))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "type": ["handleType"],
